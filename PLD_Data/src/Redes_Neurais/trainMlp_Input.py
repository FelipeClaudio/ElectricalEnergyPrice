...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  4 02:14:21 2019
...
X = pd.concat([X, pd.read_csv(INPUT_FOLDER+'/Load Energy_tsa_decomposition.csv')['residual']], axis=1)
...
#n_folds = 3
n_inits = 3
MIN_NEURONS = 41 #refazer o 40, 73, 74, 78
MAX_NEURONS = 41
...
for n_folds in range (min_folder, max_folder + 1):
    ...
    for n_neurons in range(MIN_NEURONS, MAX_NEURONS + 1):
        for ifold in range(n_folds):
            ...
            path = current_models_folder + str(n_neurons) + 'neurons_' + \

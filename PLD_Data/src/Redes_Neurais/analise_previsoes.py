...
plt.errorbar(t2, y_error, yerr=y_std, fmt='r', ecolor='black', label='desvio padrão pelo número de passos')
plt.legend()
...
plt.errorbar(t2, y_error_test, yerr=y_std_test, fmt='r', ecolor='black', label='desvio padrão pelo número de passos')
plt.legend()

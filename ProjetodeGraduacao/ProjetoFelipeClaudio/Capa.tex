...
\begin{center}
\large{Estimação do valor do preço de mercado da energia elétrica através de modelos não-lineares}\\
   \vspace{2cm}
...
\begin{flushright}
	\parbox{10cm}{
		...
		\vspace{-.375cm}
		\centering{Natanael Nunes de Moura Junior, D.Sc.}
...
Examinador:
      ...
      \begin{flushright}
         \parbox{10cm}{
            ...
            \vspace{-.375cm}
            \centering{Flávio Luis de Mello, D.Sc.}
...
Examinador:
      ...
      \begin{flushright}
         \parbox{10cm}{
            ...
            \vspace{-.375cm}
            \centering{Luiz Henrique Ramos de Azevedo Évora, D.Sc.}

...
\paragraph{}Apesar das definições acima, ainda há necessidade de definir a quantidade de neurônios na camada intermediária. Foi feito então um treinamento variando o número de neurônios entre 1 e 90 e, a partir disso, gerou-se um gráfico com o RMSE pelo número de neurônios no conjunto de validação e de teste.
...
\begin{table}[H]
	...
	\begin{center}
		...
		\caption{Resultados obtidos com as redes.}
	...
	\begin{center}
		{
			\begin{center}
				...
				\caption[\small{Sinal comple.}]{\label{completoT0} \small{Erro pelo número de época e por fold.}}
...
\paragraph{}Os 3 últimos pontos são do conjunto de dados de teste. Observa-se que a rede não conseguiu prevê-los muito bem. Isso pode se dar tanto pelo treinamento que não convergiu muito bem como pode ter ocorrido \textit{overfit}.

\paragraph{}Dado a pouca quantidade de dados, a rede não obteve o comportamento esperado nos treinamento, porém o resultado obtido mostrou que a mesma conseguiu mapear bem a entrada na saída. Sendo assim, viu-se que a rede está sendo treinada de forma coerente para obter $y(t)$ a partir de $x(t)$. Esse caso também será utilizado como base para as previsões, pois espera-se que o erro para $N$ passos a frente seja sempre maior ou igual ao caso base.
	...
	\begin{center}
		{
			\begin{center}
				...
				\caption[\small{RMSE pelo número de neurônios no conjunto de validação.}]{\label{mseValT1} \small{RMSE pelo número de neurônios no conjunto de validação.}}
	...
	\begin{center}
		{
			\begin{center}
				...
				\caption[\small{RMSE pelo número de neurônios no conjunto de teste.}]{\label{mseTestT1} \small{RMSE pelo número de neurônios no conjunto de teste.}}
	...
	\begin{center}
		{
			\begin{center}
				...
				\caption[\small{Erro pelo número de época e por fold.}]{\label{convT1} \small{Erro pelo número de época e por fold.}}
	...
	\begin{center}
		{
			\begin{center}
				...
				\caption[\small{Erro pelo número de época e por fold.}]{\label{convT1erro} \small{Erro pelo número de época e por fold.}}

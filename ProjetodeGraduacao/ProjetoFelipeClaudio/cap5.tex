	...
	\begin{center}
		{
			\begin{center}
				...
				\caption[\small{Comparação entre o sinal original e o resultado obtido.}]{\label{completoT0} \small{Comparação entre o sinal original e o resultado obtido.}}
	...
	\begin{center}
		{
			\begin{center}
				...
				\caption[\small{Comparação entre o sinal original e o resultado obtido.}]{\label{completoT1} \small{Comparação entre o sinal original e o resultado obtido.}}
	...
	\begin{center}
		{
			\begin{center}
				...
				\caption[\small{Comparação entre o sinal original e o resultado obtido.}]{\label{completoT1Error} \small{Comparação entre o sinal original e o resultado obtido.}}

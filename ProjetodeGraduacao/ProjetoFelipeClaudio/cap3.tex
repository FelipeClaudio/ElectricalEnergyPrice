	...
	\begin{center}
		{
			\begin{center}
				...
				\caption[\small{Extração de sazonalidade com periodicidade anual ($P=12$) para o dataset de nascimentos em Nova York.}]{\label{bNYsaz} \small{Extração de sazonalidade com periodicidade anual ($P=12$) para o dataset de nascimentos em Nova York. Fonte: Newton (1988). \cite{birthNY}}}
	...
	\begin{center}
		{
			\begin{center}
				...
				\caption[\small{Autocorrelação para o sinal residual do dataset de nascimentos em Nova York.}]{\label{bNYautocorr} \small{Autocorrelação para o sinal residual do dataset de nascimentos em Nova York. Fonte: Newton (1988). \cite{birthNY}}}
	...
	\begin{center}
		{
			\begin{center}
				...
				\caption[\small{Residuo sem remoção de ciclos senoidasi para o dataset de nascimentos em Nova York.}]{\label{bNYres} \small{Resíduo sem remoção de ciclos senoidais para o dataset de nascimentos em Nova York. Fonte: Newton (1988). \cite{birthNY}}}
	...
	\begin{center}
		{
			\begin{center}
				...
				\caption[\small{Resíduo com remoção de ciclos senoidais para o dataset de nascimentos em Nova York.}]{\label{bNYresFilt} \small{Resíduo com remoção de ciclos senoidais para o dataset de nascimentos em Nova York. \cite{birthNY}}}
...
\paragraph{}Como pode-se observar, a discrepância no sinal residual nas frequências próximas de $\omega_0 = 0.135rad\backslash amostra$ diminui. Além  disso, a distribuição se tornou menos espaçada (O desvio padrão mudou de aproximadamente $\sigma=0.37$ para $\sigma=0.14$).
		...
		\begin{center}
			{
				\begin{center}
					...
					\caption[\small{Validacao Cruzadas. .}]{\label{validacao_cruzada} \small{Validação cruzada. Fonte: \cite{validacao_cruzada}}}
